...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full h-full flex flex-col items-center justify-center border border-gray-200 rounded-lg shadow-md" }, _attrs))}><div class="h-4/6 w-full flex items-center justify-center"><p>img</p></div><div class="h-2/6 w-full flex items-center justify-center"><p>descr</p></div></div>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/flashcard/Card.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$3 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_FlashcardCard = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full w-full flex justify-center items-center" }, _attrs))}><div class="h-1/2 w-2/3">`);
  _push(ssrRenderComponent(_component_FlashcardCard, null, null, _parent));
  _push(`</div></div>`);
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/flashcard/Flashcard.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$2 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Flashcard = __nuxt_component_0;
  _push(`<div${ssrRenderAttrs(mergeProps({ style: { "height": "100vh", "width": "100%" } }, _attrs))}><div style="${ssrRenderStyle({ "height": "100%", "width": "100%" })}">`);
  _push(ssrRenderComponent(_component_Flashcard, null, null, _parent));
  _push(`</div></div>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BBAe7f5o.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CnABmcUa.mjs').then((r) => r.default || r));
